...
<div class="container pb-6 pt-6">
    ...
    <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/usuarioAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data" >
        ...
        <div class="columns">
            ...
            <div class="column" id="cajaDiv">
                <label>Caja de ventas </label><br>
                <div class="select">
...
<script>
// Ocultar el campo "Caja de ventas" si el cargo no es Vendedor
document.getElementById('usuario_cargo').addEventListener('change', function () {
    ...
    if (cargo === 'Vendedor') {
        cajaDiv.style.display = 'block';  // Mostrar el campo de Caja de ventas
        cajaField.setAttribute('required', true);  // Hacer que sea obligatorio
    } else {
        cajaDiv.style.display = 'none';  // Ocultar el campo de Caja de ventas
        cajaField.removeAttribute('required');  // Hacer que no sea obligatorio
        cajaField.value = '';  // Limpiar el valor del campo
    }
});
