    ...
    <div class="full-width navLateral-body">
        ...
        <nav class="full-width">
            <ul class="full-width list-unstyle menu-principal">
                ...
                <!-- Menú Inicio (Visible para todos los roles) -->
                <li class="full-width">
                ...
                <!-- Menú Cajas (Visible solo para Administradores) -->
                ...
                <!-- Menú Clientes (Visible para Administradores y Vendedores) -->
                ...
                <!-- Menú Categorías (Visible para Administradores y Bodegueros) -->
                ...
                <!-- Menú Productos (Visible para Administradores y Bodegueros) -->
                <?php if ($_SESSION['cargo'] == 'Administrador' || $_SESSION['cargo'] == 'Bodeguero'): ?>
                <li class="full-width">
                    <a href="#" class="full-width btn-subMenu">
                        <div class="navLateral-body-cl">
                ...
                <!-- Menú Ventas (Solo para Administradores y Vendedores) -->
                <?php if ($_SESSION['cargo'] == 'Administrador' || $_SESSION['cargo'] == 'Vendedor'): ?>
                <li class="full-width">
                    <a href="#" class="full-width btn-subMenu">
                        <div class="navLateral-body-cl">
                ...
                <!-- Menú Configuración (Visible para todos los roles) -->
                <li class="full-width">
                    <a href="#" class="full-width btn-subMenu">
                        <div class="navLateral-body-cl">
                    ...
                    <ul class="full-width menu-principal sub-menu-options">
                        ...
                        <?php if ($_SESSION['cargo'] == 'Administrador'): ?>
                        <li class="full-width">
                            <a href="<?php echo APP_URL."reportes/".$_SESSION['id']."/"; ?>" class="full-width">
                                <div class="navLateral-body-cl">
                                    <i class="fas fa-clipboard-list fa-fw"></i>
                                </div>
                                <div class="navLateral-body-cr">
